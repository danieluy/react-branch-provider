...
var BranchProvider = /** @class */ (function () {
  ...
  BranchProvider.prototype.getState = function () {
    return this.state;
  };
  BranchProvider.prototype.getContext = function () {
    return this.context;
  };
  BranchProvider.prototype.setUpdater = function (setFn) {
    this.update = setFn;
  };
  BranchProvider.prototype.setMethods = function () {
    var _this = this;
    /**
  ...
  BranchProvider.prototype.getMethods = function () {
    return this.methods;
  };
  BranchProvider.prototype.setState = function (value) {
    this.update(value);
  };
  BranchProvider.prototype.createContext = function (defaultValue) {
